...
/**
 * The MsgPackStream contain methods that pushes the response information as
 * bytes into the output stream. Data is then sent to the client.
 */
class MsgPackStream extends ByteArrayOutputStream {

    MsgPackStream(short cmd) {
...
/**
 * MsgEncoder sent by the server.
 * BigEndian conversion is done within MsgPackStream.
 *
...
public class MsgEncoder {
    ...
    private MsgPackStream buf;

    public MsgEncoder(short cmd) {
        buf = new MsgPackStream(cmd);
    }
